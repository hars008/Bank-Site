  ...
  <body>
   ...
   <br><br>
    <form id="Account_opening">
      <h1 style=" color: aliceblue;background-color: rgb(238, 39, 39);margin: 0px; padding: 20px; border: 2px black solid;"><center>Account Details</center></h1>
        
        <table>
          <tr>
            <td class="fields"><label for="Name">Customer Name:</label></td>
            <td class="inputs"><?php echo $result1['customer_name']?></td>
          </tr>
          <tr>
            <td class="fields"><label for="Address">Address:</label></td>
            <td class="inputs">
            <?php echo $result1['customer_street']?>
            </textarea>
            </td>
          </tr>
          <tr>
            <td class="fields"><label for="City">City:</label></td>
            <td class="inputs"> <?php echo $result1['customer_city'] ?> </td>
          </tr>
          <tr>
            <td></td>
